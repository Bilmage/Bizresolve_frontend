...
export const authApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getMyBusinesses: builder.query({
      query: (owner_id) => `business-entities/businesses/${owner_id}`,
      providesTags: ["businesses"],
    }),
    ...
    addBusinessFile: builder.mutation({
      query: (businessEntityID, formBody) => ({
        url: `file-uploads/business-file/single/${businessEntityID}`,
        method: "POST",
        body: formBody
      }),
      invalidatesTags: ["businesses"],
